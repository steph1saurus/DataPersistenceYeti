...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void ResetBinding(InputAction action, int bindingIndex)
        {
            ...
            {
                //if this the original action, continue with action
                if (otherAction == action)
                {
                    continue;
                }
                //checks for duplicates in all bindings
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .WithControlsExcluding("<Keyboard>/escape")//excludes ESC button from being used as rebinding
                .WithCancelingThrough("<Keyboard>/escape")//lets user cancel out of rebind screen
                .OnCancel(
                    operation =>
                    {
                        action.Enable();
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositParts = false)
        {
            InputBinding newBinding = action.bindings[bindingIndex];
            ...
            foreach (InputBinding binding in action.actionMap.bindings)
            {
                ...
                //if no duplicates are found, rebind will continue
            ...
            //if duplicate is found, "CheckDuplicateBindings returns TRUE
            //if no duplicates are found, "CheckDuplicateBindings returns FALSE
            return false;
        }
